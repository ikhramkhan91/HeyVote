...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableData.count == 0) {
         ...
         [self.delegate didSelectItem:tableData[indexPath.row]];
    }
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if (dic==nil) {
                          ...
                          tableData = [[NSMutableArray alloc] init];
                            ...
                            [tableData addObjectsFromArray:[dic valueForKey:@"SearchUsers_N2Result"]];
                            ...
                            self.items = [[tableData valueForKey:@"DisplayName"] filteredArrayUsingPredicate:predicate];
