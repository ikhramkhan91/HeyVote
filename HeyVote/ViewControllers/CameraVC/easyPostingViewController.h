...
@interface easyPostingViewController : UIViewController<UIImagePickerControllerDelegate, UINavigationControllerDelegate,AVAudioRecorderDelegate, AVAudioPlayerDelegate,UITextFieldDelegate,MZTimerLabelDelegate,CRColorPickerDelegate,UIGestureRecognizerDelegate,UIScrollViewDelegate,UITextFieldLimitDelegate,UIActionSheetDelegate,UITableViewDelegate,UITableViewDataSource,UIPickerViewDelegate,UIPickerViewDataSource,CLLocationManagerDelegate,UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource>{
...
@property (weak, nonatomic) IBOutlet UILabel *funHideLabel;
@property (weak, nonatomic) IBOutlet UILabel *fourImageTitle;
@property (weak, nonatomic) IBOutlet UILabel *countryHideLabel;
@property (weak, nonatomic) IBOutlet UIButton *publicValueButton;
@property (weak, nonatomic) IBOutlet UILabel *threeImageTitle;
@property (weak, nonatomic) IBOutlet UIButton *funValueButton;
@property (weak, nonatomic) IBOutlet UILabel *captureSingleImagetitle;
@property (weak, nonatomic) IBOutlet UILabel *doubleImageTitle;

@property (weak, nonatomic) IBOutlet UIButton *timeValueButton;
...
@property (weak, nonatomic) IBOutlet UIView *heyMoodVotingButtonView;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *heyMoodVotingLeftText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *heyMoodVotingRightText;
...
@property (weak, nonatomic) IBOutlet UIView *funSeriousView;
...
@property (weak, nonatomic) IBOutlet UIView *tripleImageView;

@property (weak, nonatomic) IBOutlet UIScrollView *tripleScrollView;
@property (weak, nonatomic) IBOutlet UIView *threeVersusInsideView;
@property (weak, nonatomic) IBOutlet UIView *versusButtonsView;
...
@property (weak, nonatomic) IBOutlet UIView *quadrapleImagesView;
@property (weak, nonatomic) IBOutlet UIScrollView *quadScrollView;
@property (weak, nonatomic) IBOutlet UIView *fourVersusInnerView;
- (IBAction)captureImageBackButton:(id)sender;


@property (weak, nonatomic) IBOutlet UIScrollView *capturedImageScrollView;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *threeVersusFirstText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *threeVersusSecondText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *threeVersusThirdText;
@property (weak, nonatomic) IBOutlet UIScrollView *threeVersusFirstScrollView;
@property (weak, nonatomic) IBOutlet UIScrollView *threeVersusThirdScrollView;

@property (weak, nonatomic) IBOutlet UIScrollView *threeVersusSecondScrollView;
@property (weak, nonatomic) IBOutlet UIImageView *threeVersusFirstImage;
@property (weak, nonatomic) IBOutlet UIImageView *threeVersusSecondImage;
@property (weak, nonatomic) IBOutlet UIImageView *threeVerusThirdImage;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *fourVersusFirstText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *fourVersusSecondText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *fourVersusThirdText;
@property (weak, nonatomic) IBOutlet UITextFieldLimit *fourVersusFourthText;
@property (weak, nonatomic) IBOutlet UIScrollView *fourVersusFirstScroll;
@property (weak, nonatomic) IBOutlet UIScrollView *fourVersusSecondScroll;
@property (weak, nonatomic) IBOutlet UIScrollView *fourVersusThirdScroll;
@property (weak, nonatomic) IBOutlet UIScrollView *fourVersusFourthScroll;
@property (weak, nonatomic) IBOutlet UIImageView *fourVersusFirstImage;
@property (weak, nonatomic) IBOutlet UIImageView *fourVersusSecondImage;
@property (weak, nonatomic) IBOutlet UIImageView *fourVersusThirdImage;
@property (weak, nonatomic) IBOutlet UIImageView *fourVersusFourthImage;
