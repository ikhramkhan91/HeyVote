...
@interface easyPostingViewController ()<AVCaptureFileOutputRecordingDelegate>
...
@implementation easyPostingViewController{
    UIView *newView;
    ...
    CGFloat screenWidth;
    NSString * versusButton;
    NSString * newCommonVal;
    NSMutableArray*taggedDic;
    BOOL tagVals;
...
- (void)viewDidLoad {
    ...
    taggedDic = [[NSMutableArray alloc]init];
    NSMutableDictionary * tempDic = [[NSMutableDictionary alloc]init];
    [tempDic setObject:@"" forKey:@"Idf"];
    [tempDic setObject:@"" forKey:@"X"];
    [tempDic setObject:@"" forKey:@"Y"];
  //  [taggedDic setObject:tempDic forKey:@"tagVal"];
    [taggedDic addObject:tempDic];
    tagVals = YES;
    [_thoughtTextField addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
    ...
    _thoughtTextField.delegate=self;
    
    [_thoughtTextField setHidden:YES];
    [_thoughtLabel setHidden:NO];
    
    [_previewView setHidden:YES];
    [_funSeriousView setHidden:YES];
    ...
    [_cameraButtonsView setHidden:YES];
    [_heyMoodVotingButtonView setHidden:NO];
    
    
    
    UITapGestureRecognizer *thoughtLab = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(thoughtLab:)];
    thoughtLab.numberOfTapsRequired = 1;
    [_thoughtLabel addGestureRecognizer:thoughtLab];
    _thoughtLabel.userInteractionEnabled = YES;
    
    
    
    
    _threeVersusFirstText.borderStyle = UITextBorderStyleLine;
    _threeVersusFirstText.layer.borderWidth = 2;
    _threeVersusFirstText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    _threeVersusSecondText.borderStyle = UITextBorderStyleLine;
    _threeVersusSecondText.layer.borderWidth = 2;
    _threeVersusSecondText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    
    _threeVersusThirdText.borderStyle = UITextBorderStyleLine;
    _threeVersusThirdText.layer.borderWidth = 2;
    _threeVersusThirdText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    
    
    _fourVersusFirstText.borderStyle = UITextBorderStyleLine;
    _fourVersusFirstText.layer.borderWidth = 2;
    _fourVersusFirstText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    _fourVersusSecondText.borderStyle = UITextBorderStyleLine;
    _fourVersusSecondText.layer.borderWidth = 2;
    _fourVersusSecondText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    _fourVersusThirdText.borderStyle = UITextBorderStyleLine;
    _fourVersusThirdText.layer.borderWidth = 2;
    _fourVersusThirdText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    
    _fourVersusFourthText.borderStyle = UITextBorderStyleLine;
    _fourVersusFourthText.layer.borderWidth = 2;
    _fourVersusFourthText.layer.borderColor = [[UIColor whiteColor] CGColor];
    
    
    
    // _fourVersusFourthText.borderStyle = UITextBorderStyleLine;
    _fourVersusFirstScroll.layer.borderWidth = 1;
    _fourVersusFirstScroll.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _fourVersusSecondScroll.layer.borderWidth = 1;
    _fourVersusSecondScroll.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _fourVersusThirdScroll.layer.borderWidth = 1;
    _fourVersusThirdScroll.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _fourVersusFourthScroll.layer.borderWidth = 1;
    _fourVersusFourthScroll.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _threeVersusFirstScrollView.layer.borderWidth = 1;
    _threeVersusFirstScrollView.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _threeVersusSecondScrollView.layer.borderWidth = 1;
    _threeVersusSecondScrollView.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    
    _threeVersusThirdScrollView.layer.borderWidth = 1;
    _threeVersusThirdScrollView.layer.borderColor = [[UIColor darkGrayColor] CGColor];
    ...
    [_secondImageView addGestureRecognizer:tapGesture1];
    
    UITapGestureRecognizer *tapGestureVersusThree1 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusThree1:)];
    
    [_threeVersusFirstImage addGestureRecognizer:tapGestureVersusThree1];
    
    UITapGestureRecognizer *tapGestureVersusThree2 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusThree2:)];
    
    [_threeVersusSecondImage addGestureRecognizer:tapGestureVersusThree2];
    
    UITapGestureRecognizer *tapGestureVersusThree3 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusThree3:)];
    
    [_threeVerusThirdImage addGestureRecognizer:tapGestureVersusThree3];
    
    
    
    UITapGestureRecognizer *tapGestureVersusFour1 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusFour1:)];
    
    [_fourVersusFirstImage addGestureRecognizer:tapGestureVersusFour1];
    
    UITapGestureRecognizer *tapGestureVersusFour2 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusFour2:)];
    
    [_fourVersusSecondImage addGestureRecognizer:tapGestureVersusFour2];
    
    
    UITapGestureRecognizer *tapGestureVersusFour3 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusFour3:)];
    
    [_fourVersusThirdImage addGestureRecognizer:tapGestureVersusFour3];
    
    UITapGestureRecognizer *tapGestureVersusFour4 = [[UITapGestureRecognizer alloc] initWithTarget:self  action:@selector(tapGestureVersusFour4:)];
    
    [_fourVersusFourthImage addGestureRecognizer:tapGestureVersusFour4];
...
//    [_voiceDoubleView addGestureRecognizer:swiperighttt];
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        AVCaptureDevice *videoDevice = [easyPostingViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionBack];
...
-(void)configureController{
    ...
    for (int i=0; i<20; i++) {
        [totalItems addObject:[NSString stringWithFormat:@""]];
    }
...
- (void) thoughtLab: (id)sender
{
    //handle Tap...
    
    
    [_thoughtLabel setHidden:YES];
    [_thoughtTextField setHidden:NO];
    [_thoughtTextField becomeFirstResponder];
...
- (void) tapGestureVersusThree1: (id)sender
{
...
- (void) tapGestureVersusThree2: (id)sender
{
...
- (void) tapGestureVersusThree3: (id)sender
{
...
- (void) tapGestureVersusFour1: (id)sender
{
...
- (void) tapGestureVersusFour2: (id)sender
{
...
- (void) tapGestureVersusFour3: (id)sender
{
...
- (void) tapGestureVersusFour4: (id)sender
{
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    self.quadScrollView.contentSize = CGSizeMake(self.fourVersusInnerView.frame.size.width, self.fourVersusInnerView.frame.size.height);
    self.tripleScrollView.contentSize = CGSizeMake(self.threeVersusInsideView.frame.size.width, self.threeVersusInsideView.frame.size.height);
    //  _tripleScrollView.contentSize = CGSizeMake(_tripleScrollView.contentSize.width,_tripleScrollView.frame.size.height);
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    label.text = self.theData[row];
     [self.timeValueButton setTitle:self.theData[row] forState:UIControlStateNormal];
    ...
    if ( gesture.state == UIGestureRecognizerStateEnded ) {
        ...
        dispatch_async( self.sessionQueue, ^{
            if ( ! self.movieFileOutput.isRecording ) {
                ...
                [easyPostingViewController setFlashMode:AVCaptureFlashModeOff forDevice:self.videoDeviceInput.device];
...
- (IBAction)flashButton:(id)sender
{
    ...
    if ([flashString isEqualToString:@""]) {
        ...
        [easyPostingViewController setFlashMode:AVCaptureFlashModeOn forDevice:self.videoDeviceInput.device];
...
- (IBAction)changeCamera:(id)sender
{
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        AVCaptureDevice *videoDevice = [easyPostingViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
        ...
        if ( [self.session canAddInput:videoDeviceInput] ) {
            ...
            [easyPostingViewController setFlashMode:AVCaptureFlashModeAuto forDevice:videoDevice];
...
- (IBAction)snapStillImage:(id)sender
{
    dispatch_async( self.sessionQueue, ^{
        ...
        previewLayer.videoGravity = AVLayerVideoGravityResizeAspectFill;
        [easyPostingViewController setFlashMode:AVCaptureFlashModeAuto forDevice:self.videoDeviceInput.device];
...
-(void) imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if ([[info valueForKey:@"UIImagePickerControllerMediaType"] isEqualToString:@"public.image"]) {
        ...
        if ([cameraVal isEqualToString:@""]) {
        ...
        else if ([cameraVal isEqualToString:@"RightImage"]){
        ...
        else if ([cameraVal isEqualToString:@"threeVersusOne"]){
        ...
        else if ([cameraVal isEqualToString:@"threeVersusTwo"]){
        ...
        else if ([cameraVal isEqualToString:@"threeVersusThree"]){
        ...
        else if ([cameraVal isEqualToString:@"fourVersusOne"]){
        ...
        else if ([cameraVal isEqualToString:@"fourVersusTwo"]){
        ...
        else if ([cameraVal isEqualToString:@"fourVersusThree"]){
        ...
        else if ([cameraVal isEqualToString:@"fourVersusFour"]){
            ...
            [_fourVersusFourthImage setImage:image];
...
- (IBAction)cameraFunButton:(id)sender {
    moodString = @"Fun";
      ...
      [self.funValueButton setTitle:@"Fun" forState:UIControlStateNormal];
    ...
    [UIView animateWithDuration:0.5 animations:^{
        _funSeriousView.alpha = 0;
    } completion: ^(BOOL finished) {//creates a variable (BOOL) called "finished" that is set to *YES* when animation IS completed.
        _funSeriousView.hidden = finished;//if animation is finished ("finished" == *YES*), then hidden = "finished" ... (aka hidden = *YES*)
    }];
...
- (IBAction)cameraSeriousButton:(id)sender {
    ...
    moodString = @"Serious";
      ...
      [self.funValueButton setTitle:@"Serious" forState:UIControlStateNormal];
...
- (IBAction)cameraGeneralButton:(id)sender {
    ...
    moodString = @"General";
      ...
      [self.funValueButton setTitle:@"General" forState:UIControlStateNormal];
...
- (IBAction)cameraPrivateButton:(id)sender {
    ...
    privateCategory = @"Private";
      ...
      [self.publicValueButton setTitle:@"Private" forState:UIControlStateNormal];
...
- (IBAction)cameraQatarButton:(id)sender {
    ...
    privateCategory = @"Country";
       ...
       [self.publicValueButton setTitle:[[[[[NSUserDefaults standardUserDefaults] objectForKey:@"basicInformation"] allObjects] valueForKey:@"Country"] objectAtIndex:0] forState:UIControlStateNormal];
...
- (IBAction)cameraGlobalButton:(id)sender {
    ...
    privateCategory = @"Global";
       ...
       [self.publicValueButton setTitle:@"Global" forState:UIControlStateNormal];
    //
    //    [_cameraPrivateButton setImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
    //    [_cameraQatarButton setImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
...
//    [self dismissViewControllerAnimated:YES completion:nil];
    ...
    if ([newCommonVal isEqualToString:@"video"]) {
         [_galleryView setHidden:YES];
        [_heyMoodVotingButtonView setHidden:YES];
    }
    else{
        newCommonVal = @"";
        [_galleryView setHidden:YES];
...
-(void)colorIsChanging:(UIColor *)color{
    [_thoughtLabel setTextColor:color];
    
    [_thoughtTextField setTextColor:color];
    [_captureSingleImagetitle setTextColor:color];
     [_threeImageTitle setTextColor:color];
     [_fourImageTitle setTextColor:color];

  
 //   [_heyMoodTextView setTextColor:color];
...
-(void)textFieldDidBeginEditing:(UITextField *)textField{
    ...
    if ([newCommonVal isEqualToString:@""] || [newCommonVal isEqualToString:@"video"] || [newCommonVal isEqualToString:@"voice"]) {
...
-(void)textFieldDidChange :(UITextField *)theTextField{
    ...
    if ([theTextField.text containsString:@"@"]) {
        ...
        [_thoughtTextField resignFirstResponder];
        
        [SRPopView showWithButton:@"" andArray:totalItems andHeading:@"Tag your friends" andCallback:^(NSString *itemPicked) {
            NSLog(@"pickedddd : %@",itemPicked);
            ...
            [strArr addObject:itemPicked];
            
            
            NSString *strr = @"@";
            NSString* finVal = [NSString stringWithFormat:@" %@ ",[[strArr valueForKey:@"DisplayName"] objectAtIndex:0]];
            
            _thoughtLabel.text = [_thoughtLabel.text stringByReplacingOccurrencesOfString:strr
                                                 withString:finVal];
            
            _thoughtTextField.text = _thoughtLabel.text;
            _heyMoodTextView.text = _thoughtLabel.text;
            
            
            NSMutableDictionary * tempDic = [[NSMutableDictionary alloc]init];
            
            [tempDic setObject:[[strArr valueForKey:@"UserIdf"] objectAtIndex:0] forKey:@"Idf"];
            [tempDic setObject:@"" forKey:@"X"];
            [tempDic setObject:@"" forKey:@"Y"];
...
-(void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    if ([_thoughtTextField.text isEqualToString:@""]) {
        _thoughtLabel.text = @"Post your thought for voting...";
    }
    
    else{
        
        if ([newCommonVal isEqualToString:@""]) {
            _thoughtLabel.text = _thoughtTextField.text;
            _heyMoodTextView.text = _thoughtLabel.text;
            _captureSingleImagetitle.text = _thoughtTextField.text;
            _doubleImageTitle.text = _thoughtTextField.text;
            _threeImageTitle.text = _thoughtTextField.text;
            _fourImageTitle.text = _thoughtTextField.text;
        }
        else{
    _thoughtLabel.text = _thoughtTextField.text;
            _captureSingleImagetitle.text = _thoughtTextField.text;
...
-(void)scrollViewDidZoom:(UIScrollView *)scrollView{
    ...
    if (scrollView == _firstScrollView) {
    ...
    else if(scrollView == _secondscrollView){
    ...
    else  if (scrollView == _capturedImageScrollView) {
        
        
        
        CGSize boundsSize = _capturedImageScrollView.bounds.size;
        CGRect contentsFrame = _capturedImageView.frame;
        ...
        _capturedImageView.frame = contentsFrame;
        
    }
    
    else  if (scrollView == _threeVersusFirstScrollView) {
        
        
        
        CGSize boundsSize = _threeVersusFirstScrollView.bounds.size;
        CGRect contentsFrame = _threeVersusFirstImage.frame;
        ...
        _threeVersusFirstImage.frame = contentsFrame;
        
    }
    
    
    else  if (scrollView == _threeVersusSecondScrollView) {
        
        
        
        CGSize boundsSize = _threeVersusSecondScrollView.bounds.size;
        CGRect contentsFrame = _threeVersusSecondImage.frame;
        ...
        _threeVersusSecondImage.frame = contentsFrame;
        
    }
    
    else  if (scrollView == _threeVersusThirdScrollView) {
        
        
        
        CGSize boundsSize = _threeVersusThirdScrollView.bounds.size;
        CGRect contentsFrame = _threeVerusThirdImage.frame;
        ...
        _threeVerusThirdImage.frame = contentsFrame;
        
    }
    
    
    else  if (scrollView == _fourVersusFirstScroll) {
        
        
        
        CGSize boundsSize = _fourVersusFirstScroll.bounds.size;
        CGRect contentsFrame = _fourVersusFirstImage.frame;
        ...
        _fourVersusFirstImage.frame = contentsFrame;
        
    }
    
    
    
    else  if (scrollView == _fourVersusSecondScroll) {
        
        
        
        CGSize boundsSize = _fourVersusSecondScroll.bounds.size;
        CGRect contentsFrame = _fourVersusSecondImage.frame;
        ...
        _fourVersusSecondImage.frame = contentsFrame;
        
    }
    
    else  if (scrollView == _fourVersusThirdScroll) {
        
        
        
        CGSize boundsSize = _fourVersusThirdScroll.bounds.size;
        CGRect contentsFrame = _fourVersusThirdImage.frame;
        ...
        _fourVersusThirdImage.frame = contentsFrame;
        
    }
    
    
    else  if (scrollView == _fourVersusFourthScroll) {
        
        
        
        CGSize boundsSize = _fourVersusFourthScroll.bounds.size;
        CGRect contentsFrame = _fourVersusFourthImage.frame;
        ...
        _fourVersusFourthImage.frame = contentsFrame;
...
- (UIView *)viewForZoomingInScrollView:(UIScrollView *)scrollView
{
    ...
    if (scrollView == _firstScrollView) {
        ...
        return  _threeVersusSecondImage;
...
//            
    ...
    if (tableView == _galleryTableView) {
...
(NSIndexPath *)indexPath{
    ...
    if (tableView==_galleryTableView) {
            ...
            NSIndexPath *indexPathh = [NSIndexPath indexPathForItem:item inSection:section];
            [self.myCollectionView scrollToItemAtIndexPath:indexPathh atScrollPosition:(UICollectionViewScrollPositionBottom) animated:NO];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[[_assets objectAtIndex:indexPath.row] valueForProperty:ALAssetPropertyType] isEqualToString:ALAssetTypePhoto]) {
        ...
        if (iref) {
            ...
            _threeVersusFirstImage.image = [UIImage imageWithCGImage:iref scale:[rep scale]
                                                         orientation:UIImageOrientationUp];
            _fourVersusFirstImage.image = [UIImage imageWithCGImage:iref scale:[rep scale]
                                                        orientation:UIImageOrientationUp];
        }
...
- (IBAction)camerViewOpenButton:(id)sender {
    ...
    [_cameraButtonsView setHidden:NO];
    // [_voicePlayerView setHidden:YES];
...
- (IBAction)versusTwo:(id)sender {
    versusButton = @"versusTwo";
      [_captureSingleImagetitle setHidden:NO];
    [_doubleImageView setHidden:NO];
    [_tripleImageView setHidden:YES];
    [_quadrapleImagesView setHidden:YES];
...
- (IBAction)versusThree:(id)sender {
    versusButton = @"versusThree";
...
- (IBAction)thoughtCamera:(id)sender {
...
- (IBAction)thoughtVideo:(id)sender {
     newCommonVal = @"video";
     [_captureSingleImagetitle setHidden:NO];
...
- (IBAction)thoughtVoice:(id)sender {
     newCommonVal = @"";
     [_captureSingleImagetitle setHidden:NO];
    [[NSUserDefaults standardUserDefaults]removeObjectForKey:@"savedVideo"];
    [[NSUserDefaults standardUserDefaults]synchronize];
...
- (IBAction)publicValueButton:(id)sender {
    
      [_finalView setHidden:YES];
    [_countryHideLabel setHidden:YES];
    [_funHideLabel setHidden:NO];
    
    
    _funSeriousView.alpha = 0;
    _funSeriousView.hidden = NO;
    [UIView animateWithDuration:0.5 animations:^{
        _funSeriousView.alpha = 1;
    }];
...
- (IBAction)funValueButton:(id)sender {
    
     [_finalView setHidden:YES];
    [_countryHideLabel setHidden:NO];
    [_funHideLabel setHidden:YES];
    _funSeriousView.alpha = 0;
    _funSeriousView.hidden = NO;
    [UIView animateWithDuration:0.5 animations:^{
        _funSeriousView.alpha = 1;
...
- (IBAction)timeValueButton:(id)sender {
    [_funSeriousView setHidden:YES];

    _finalView.alpha = 0;
    _finalView.hidden = NO;
    [UIView animateWithDuration:0.5 animations:^{
        _finalView.alpha = 1;
    }];
...
-(void)newWebServiceCallEasy{
    ...
    if ([[_funValueButton titleForState:UIControlStateNormal] isEqualToString:@"Fun"]) {
        categoryID = 1;
    }
    
    else if ([[_funValueButton titleForState:UIControlStateNormal] isEqualToString:@"Serious"]){
        
        categoryID = 2;
        
    }
    
    else if([[_funValueButton titleForState:UIControlStateNormal] isEqualToString:@"General"]){
        
        categoryID = 3;
    }
    
    if ([[_timeValueButton titleForState:UIControlStateNormal] containsString:@"hours"] || [[_timeValueButton titleForState:UIControlStateNormal] containsString:@"hour"] ) {
        
        NSArray * arr = [[_timeValueButton titleForState:UIControlStateNormal] componentsSeparatedByString:@" "];
        
        durationInt = [[arr objectAtIndex:0] integerValue] * 60;
        
    }
    
    else if ([[_timeValueButton titleForState:UIControlStateNormal] containsString:@"mins"]){
        NSArray * arr = [[_timeValueButton titleForState:UIControlStateNormal] componentsSeparatedByString:@" "];
    ...
    if ([newCommonVal isEqualToString:@""]) {
        ...
        if ([_thoughtLabel.text isEqualToString:@""] || [_thoughtLabel.text isEqualToString:@"Post your thought for voting..."]) {
            [self showToast:@"Describe your thoughts for voting..."];
        }
        
        else if ([_heyMoodVotingLeftText.text length] == 0 || [_heyMoodVotingRightText.text length] == 0 ){
            
             [self showToast:@"Type your caption for voting..."];
            ...
            if ([[_publicValueButton titleForState:UIControlStateNormal] isEqualToString:@"Private"]) {
        ...
        else if ([[_publicValueButton titleForState:UIControlStateNormal] isEqualToString:@"Private"] && cellSelected.count == 0){
                        ...
                        if ([[_publicValueButton titleForState:UIControlStateNormal] isEqualToString:@"Private"]) {
                            ...
                            jsonDictionary =@{
                                              ...
                                              @"info":@{
                                                      ...
                                                      @"Title":@":)", // title text
                                                      @"Caption1":_heyMoodVotingLeftText.text, //  button 1 text
                                                      @"Caption2":_heyMoodVotingRightText.text,
                            ...
                            if (error) {
                                ...
                                dispatch_async(dispatch_get_main_queue(), ^{
                                    ...
                                    if (dic==nil) {
                                        ...
                                        _threeVersusFinalText.text=@"";
                                        _fourVersusFinalText.text=@"";
                                        _heyMoodVotingRightText.text = @"";
                                        _heyMoodVotingLeftText.text = @"";
    ...
    else if ([newCommonVal isEqualToString:@"image"]){
        ...
        if ([versusButton isEqualToString:@"versusTwo"]) {
            ...
            else if (_firstImageView.image == nil || _secondImageView.image == nil){
                
                 [self showToast:@"Please select the images for posting."];
            }
            ...
            if ([privateCategory isEqualToString:@"Private"]) {
                ...
                jsonDictionary =@{
                                  ...
                                  @"info":@{
                                          ...
                                          @"IsPublic":[NSNumber numberWithInt:0], // i ll explain this by call
                                          @"TerritoryId":[NSNumber numberWithInt:0], //send always 0
                                          @"Title":_thoughtLabel.text, // title text
            ...
            else if (_capturedImageView.image == nil ){
                
                [self showToast:@"Please select the images for posting."];
            }
            
            else if ([_singleImageLeftText.text length] == 0 || [_singleImageRightText.text length] == 0 ){
            ...
            if ([_thoughtLabel.text isEqualToString:@""] || [_thoughtLabel.text isEqualToString:@"Post your thought for voting..."]) {
            ...
            else if (_threeVersusFirstImage.image == nil || _threeVersusSecondImage.image == nil || _threeVerusThirdImage.image == nil){
              ...
              else if( _finalImageThreeVersusAndFour.image == nil){
            ...
            else if ( _fourVersusFirstImage.image == nil ||  _fourVersusSecondImage.image == nil ||  _fourVersusThirdImage.image == nil ||  _fourVersusFourthImage.image == nil){
    ...
    else if ([newCommonVal isEqualToString:@"video"]){
        NSString*rtest  =   [[NSUserDefaults standardUserDefaults]valueForKey:@"savedVideo"];
        ...
        else if ([_singleVoiceLeftText.text length] == 0 || [_singleVoiceRightText.text length] == 0 ){
       ...
       else if ([privateCategory isEqualToString:@"Private"] && cellSelected.count == 0) {
        ...
        else if ([rtest length] == 0 ) {
            
            [self showToast:@"Please record or select a video to post !"];
    ...
    else if ([newCommonVal isEqualToString:@"voice"]){
...
- (IBAction)captureImageBackButton:(id)sender {
