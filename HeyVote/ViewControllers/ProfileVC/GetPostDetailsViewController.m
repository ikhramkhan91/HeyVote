...
- (void)viewDidLoad {
  ...
  //  [self callMainWebService];
    ...
    if (globalArray.count == 0) {
        ...
        if ([_hashTagValString isEqualToString:@"hashTag"]) {
            
            _hashTagTextLabel.text = [NSString stringWithFormat:@"#%@",_hashTagName];
            
            [self callHashService];
            
        }
        
        else{
            
            _hashTagTextLabel.text = @"";
             [self callWebService];
        }
...
-(void)callHashService{
    ...
    if (interNetCheck==YES ) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSMutableURLRequest *requestPost =[NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://www.heyvote.com/WebServices/HeyVoteService.svc/Posts/GetHashPostList"]];
                ...
                if (error) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if (dic == nil) {
                            ...
                            [globalArray addObjectsFromArray:[dic valueForKey:@"GetHashPostListResult"]];
